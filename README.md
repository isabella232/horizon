...
* [ScalaDocs](https://paypal.github.com/horizon/api/0.3.2/index.html#com.paypal.horizon.package)
...
[View the list of build utility keys](https://paypal.github.com/horizon/api/0.3.2/index.html#com.paypal.horizon.BuildUtilitiesKeys$)
...
[View the Scaladocs](https://paypal.github.com/horizon/api/0.3.2/#com.paypal.horizon.ChangelogReleaseSteps$)
...
[View the Scaladocs](https://paypal.github.com/horizon/api/0.3.2/#com.paypal.horizon.ReadmeReleaseSteps$)
...
This setting reads as "Any time there is 0.3.2 in the template, replace it with the current build version". You can define placeholders as needed in your project's build settings using the `<<=` operator to add additional settings to the exisiting set or the `:=` operator to define your own set.
...
[View the Scaladocs](https://paypal.github.com/horizon/api/0.3.2/#com.paypal.horizon.ScaladocReleaseSteps$)
